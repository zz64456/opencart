...
/*
	...
	extension/ka_extensions/kamod/admin/controller/marketplace/installer.php.xml
...
/*
	...
	Original file: admin/controller/marketplace/installer.php
*/
 ...
 */
class Installer_kamod extends \Opencart\System\Engine\Controller  {
	/**
	 * @return void
	 */
			...
			foreach ($files as $file) {
				...
				if (isset($output['autoload'])) {
					...
					if (isset($output['autoload']['files'])) {
						...
						foreach ($files as $file) {
							$code .= '@include_once(DIR_STORAGE . \'vendor/' . $directory . '/' . $file . '\');' . "\n";
						}
					}
				}
